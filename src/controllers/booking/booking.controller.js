  ...
  try {
    ...
    sendmail(
      ...
      ` <p> Hello </p><strong> ${userInfo.username}, </strong> </br>
            <p> your requested tickets ${finalReqArr} has been confirmed</p></br>
            <p> Travelling Details </p>
            <p> Bus Number : ${busData.busnumber} <br>
            <p> On Date <strong> ${tripData.travelDate} </strong> </br>
            <p> <strong> ${tripData.startingPoint} - ${tripData.destinationPoint} </strong> </p>
    ...
    if (!cancelBookingData) {
      ...
      sendmail(
        ...
        ` <p> Hello </p><strong> ${userData.username}, </strong> </br>
            <p> your requested tickets ${seats} has been canceled</p></br>
            <p> Travelling Details </p>
            <p> On Date <strong> ${trip.travelDate} </strong> </br>
            <p> <strong> ${trip.startingPoint} - ${trip.destinationPoint} </strong> </p>
